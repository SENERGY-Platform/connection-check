...
type ConfigStruct struct {
	...
	ConnectionLogStateUrl string   `json:"connection_log_state_url"`
	VernemqManagementUrl  string   `json:"vernemq_management_url"`
	...
	HubLogTopic    string `json:"hub_log_topic"`
